"""
Django settings for the_purse_shop project.
...
SECRET_KEY = 'django-insecure-@6e3l_rwc*umjs!e6otxo^m*rlq_uc&smc#ex79$0y@n77r%-5'
...
ROOT_URLCONF = 'the_purse_shop.urls'
...
WSGI_APPLICATION = 'the_purse_shop.wsgi.application'
